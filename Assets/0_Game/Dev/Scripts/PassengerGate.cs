...
namespace _0_Game.Dev.Scripts
{
    public class PassengerGate : MonoBehaviour
    {
        [SerializeField] private PassengerData currentPassengers;
        //passenger List
        [SerializeField] private List<PassengerData> passengers;

        public void Init(List<PassengerData> passengerData)
        {
